...
declare module lark {
    ...
    interface XML extends XMLNode {
        ...
        /**
         * @language en_US
         * the namesapce uri of this xml node.For example,the namespace uri of <s:Skin xmlns:s="http://ns.lark.com/swan"/> is "http://ns.lark.com/swan".
         * @version Lark 1.0
         * @platform Web,Native
         */
        /**
         * @language zh_CN
         * 节点的命名空间地址。例如节点 <s:Skin xmlns:s="http://ns.lark.com/swan"/> 的 namespace 为： http://ns.lark.com/swan
         * @version Lark 1.0
         * @platform Web,Native
         */
        namespace: string;
...
declare module lark {
     ...
     *
     * @event lark.Event.COMPLETE Emit when a sound has finished playing
     * @version Lark 1.0
     * @platform Web,Native
     * @includeExample examples/Samples/src/lark/media/SoundExample.ts
     */
    ...
    * @language zh_CN
     ...
     *
     * @event lark.Event.ENDED 音频播放完成时抛出
     * @version Lark 1.0
     * @platform Web,Native
     * @includeExample examples/Samples/src/lark/media/SoundExample.ts
    */
